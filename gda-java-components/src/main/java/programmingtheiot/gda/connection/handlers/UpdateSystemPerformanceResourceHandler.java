...
public class UpdateSystemPerformanceResourceHandler extends CoapResource {
    ...
    public void handleGET(CoapExchange context) {
        _Logger.info("GET called on SystemPerfMsg. No action taken.");
        context.respond(ResponseCode.METHOD_NOT_ALLOWED);
    }

    @Override
    public void handlePOST(CoapExchange context) {
        _Logger.info("POST called on SystemPerfMsg. No action taken.");
        context.respond(ResponseCode.METHOD_NOT_ALLOWED);
    }

    @Override
    public void handleDELETE(CoapExchange context) {
        _Logger.info("DELETE called on SystemPerfMsg. No action taken.");
        context.respond(ResponseCode.METHOD_NOT_ALLOWED);
    }
}